...
//		if(rectangle.intersects(collidingRect)) // checks intersection, won't detect if rectangle goes within collidingRect
		if(rectangle.intersects(collidingRect) || collidingRect.contains(rectangle)) // checks both intersection and contains
